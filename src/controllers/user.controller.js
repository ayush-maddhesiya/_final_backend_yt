...
export { registerUser, loginUser, logoutUser, getCurrentUser, passwordChange, refreshAccessToken, updateAccountDetails, updateUserAvatar, updateUserCoverImage ,getHistory};